...
int main(int argc, char** argv) {
    ...
    readObj("models/Stanford Bunny.obj", triangles, m, getTransformMatrix(vec3(0, 0, 0), vec3(0, -0.5, 0), vec3(0.75, 0.75, 0.75)), true);
    //readObj("models/backpack.obj", triangles, m, getTransformMatrix(vec3(0, 0, 0), vec3(0, -0.5, 0), vec3(0.75, 0.75, 0.75)), true);
    ...
    bool r = HDRLoader::load("./HDR/newport_loft.hdr", hdrRes);
    ...
    pass1.program = getShaderProgram("./shaders/fshader.fs", "./shaders/vshader.vs");
    ...
    pass2.program = getShaderProgram("./shaders/pass2.fs", "./shaders/vshader.vs");
    lastFrame = getTextureRGB32F(pass2.width, pass2.height);
    pass2.colorAttachments.push_back(lastFrame);
    pass2.bindData();

    pass3.program = getShaderProgram("./shaders/pass3.fs", "./shaders/vshader.vs");
    pass3.bindData(true);
