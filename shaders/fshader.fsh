...
int seed = int(
    int((pix.x * 0.5 + 0.5) * width)  * int(1973) + 
    int((pix.y * 0.5 + 0.5) * height) * int(9277) + 
    int(frameCounter) * int(26699)) | int(1);
...
int seed_sync = int(
    int((pix.x * 0.0 + 0.5) * width)  * int(1973) + 
    int((pix.y * 0.0 + 0.5) * height) * int(9277) + 
    int(114514) * int(26699)) | int(1);
...
vec2 CranleyPattersonRotation(vec2 p) {
    int pseed = int(
        int((pix.x * 0.5 + 0.5) * width)  * int(1973) + 
        int((pix.y * 0.5 + 0.5) * height) * int(9277) + 
        int(114514/1919) * int(26699)) | int(1);
